...
import com.petstore.api.core.PetStoreConfigApi;
import com.petstore.api.fixture.datayamlloader.classes.user.UserData;
import io.qameta.allure.Step;
import io.restassured.response.Response;

import static com.petstore.api.fixture.ApiEndpointsURL.USER;
import static com.petstore.api.fixture.datayamlloader.classes.user.UserDataTypes.USER_EMAIL;
import static com.petstore.api.fixture.datayamlloader.classes.user.UserDataTypes.USER_FIRST_NAME;
import static com.petstore.api.fixture.datayamlloader.classes.user.UserDataTypes.USER_ID;
import static com.petstore.api.fixture.datayamlloader.classes.user.UserDataTypes.USER_LAST_NAME;
import static com.petstore.api.fixture.datayamlloader.classes.user.UserDataTypes.USER_PASSWORD;
import static com.petstore.api.fixture.datayamlloader.classes.user.UserDataTypes.USER_PHONE;
import static com.petstore.api.fixture.datayamlloader.classes.user.UserDataTypes.USER_STATUS;
import static com.petstore.api.fixture.datayamlloader.classes.user.UserDataTypes.USER_USERNAME;
import static com.petstore.api.models.user.IncomingUserModel.getUserCreateModel;
import static com.petstore.api.models.user.IncomingUserModel.getUserEditModel;

public class UserConfig extends PetStoreConfigApi {
